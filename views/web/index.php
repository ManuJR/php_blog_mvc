...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= BASE_FOLDER ?>/assets/css/style.css">
	<script src="<?= BASE_FOLDER ?>/assets/js/functions.js"></script>
</head>
<body>
    <?php
		...
		<div id="articles_content" class="d-flex align-items-start">
			...
			<?php
				...
				foreach ($articles as $article) {
					require($_SERVER['DOCUMENT_ROOT'].BASE_FOLDER."/modules/article/thumb.php");
				}
			?>
