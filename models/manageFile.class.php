    ...
    */
    class ManageFile{
        ...
        public static function createFolder( $uri_folder ){
            if( !file_exists($_SERVER['DOCUMENT_ROOT'].BASE_FOLDER.$uri_folder ) ){
                mkdir( $_SERVER['DOCUMENT_ROOT'].BASE_FOLDER.$uri_folder );
            }
        }

        public static function exists( $file ){
            if( !file_exists($_SERVER['DOCUMENT_ROOT'].BASE_FOLDER.$file ) ){
                return false;
            }
            return true;
        }
        ...
        public static function uploadFile( $origin, $destination){
            if( !move_uploaded_file( $origin,  $_SERVER['DOCUMENT_ROOT'].BASE_FOLDER.$destination)){
                return false;
            }
            return true;
        }
        ...
        public static function deleteFile( $file ){
            if( file_exists(  $_SERVER['DOCUMENT_ROOT'].BASE_FOLDER.$file ) ){
                unlink($_SERVER['DOCUMENT_ROOT'].BASE_FOLDER.$file);
                return;
            }
        }
